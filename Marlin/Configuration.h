...
#define STRING_CONFIG_H_AUTHOR "Mr Dog" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Pro Plus"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 8.5911
    #define DEFAULT_Ki 1.0629
    #define DEFAULT_Kd 17.3604
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 410, 140 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 0, -0.9 }
